...
HD_PWD='C:/Users/Hello/Desktop/FPGAÏîÄ¿/FPGA-IMAGE-01/UDH/UDH.runs/wrfifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wrfifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wrfifo.tcl
